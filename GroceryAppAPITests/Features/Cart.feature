...
And the response body should be '{"Id": 1, "UserId": 1, "ProductIds": [1,2]}'
...
When the user sends POST request to the 'users/1/carts' endpoint with the data '{"UserId": 1, "ProductId": 1}'
Then the response status code should be 200
And the response body should be '{"Id": 2}'
...
When the user sends POST request to the 'users/1/carts' endpoint with the data '{"UserId": 1, "ProductId": 0}'
Then the response status code should be 400
...
When the user sends PUT request to the 'users/2/carts/3' endpoint with the data '{"UserId": 2, "ProductId": 2, "OperationType": 1}'
Then the response status code should be 200
...
When the user sends PUT request to the 'users/2/carts/3' endpoint with the data '{"UserId": 2, "ProductId": 1, "OperationType": 2}'
Then the response status code should be 200
And the response body should be '{"Message": "Cart updated successfully."}'

@cart-updation-failed
Scenario: Cart updation failed due to cart not found
When the user sends PUT request to the 'users/2/carts/14' endpoint with the data '{"UserId": 2, "ProductId": 3, "OperationType": 1}'
Then the response status code should be 400
...
When the user sends PUT request to the 'users/2/carts/3' endpoint with the data '{"UserId": 2, "ProductId": 18, "OperationType": 1}'
Then the response status code should be 400
...
When the user sends PUT request to the 'users/2/carts/3' endpoint with the data '{"UserId": 2, "ProductId": 3, "OperationType": 3}'
Then the response status code should be 400
...
When the user sends PUT request to the 'users/2/carts/4' endpoint with the data '{"UserId": 2, "ProductId": 3, "OperationType": 3}'
Then the response status code should be 400
...
When the user sends DELETE request to the 'users/2/carts/4' endpoint
Then the response status code should be 200
...
@cart-deletion-failed
Scenario: Cart deletion failed due to cart not found
When the user sends DELETE request to the 'users/2/carts/40' endpoint
Then the response status code should be 400
And the response body should be '{"Message": "Cart with id 40 is not found."}'

@cart-deletion-failed
Scenario: Cart deletion failed due to cart does not belong to the user
When the user sends DELETE request to the 'users/2/carts/1' endpoint
Then the response status code should be 400
And the response body should be '{"Message": "Cart does not belong to the user."}'